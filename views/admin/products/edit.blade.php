                ...
                <div class="card-body">
                    <div class="container">
                        <form action="/admin/products/update/{{ $product['p_id'] }}" method="POST"
                            ...
                            <div>
                                ...
                                <div class="col-8">
                                    <textarea class="form-control" name="content" id="content"
                                        rows="3">{{!! $product['p_content'] !!}}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                <label for="price_sale" class="col-4 col-form-label">Sale Price</label>
                                <div class="col-8">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    <input type="checkbox" class="form-checkbox" @checked($product['p_is_active']) value="1" name="is_active" id="is_active" />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="is_sale" class="col-4 col-form-label">Is sale</label>
                                <div class="col-8">
                                    <input type="checkbox" class="form-checkbox" @checked($product['p_is_sale']) value="1" name="is_sale" id="is_sale" />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="is_show_home" class="col-4 col-form-label">Is sale</label>
                                <div class="col-8">
                                    <input type="checkbox" class="form-checkbox" @checked($product['p_is_show_home']) value="1" name="is_show_home" id="is_show_home" />
                                </div>
                            </div>
                            <div class="mb-3 row">
